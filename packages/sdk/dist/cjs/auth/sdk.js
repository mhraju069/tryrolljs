...
var SDK = /** @class */function () {
  function SDK(config, storage) {
      ...
      return tslib_es6.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_es6.__generator(this, function (_d) {
          switch (_d.label) {
            ...
            case 2:
              _d.sent();
              throw new errors.NotEnoughDataToRefreshError();
            case 3:
            ...
            case 4:
              _d.trys.push([4, 7,, 9]);
              return [4 /*yield*/, api.requestToken({
                issuerUrl: this.config.issuerUrl,
                grantType: types.GrantType.RefreshToken,
        ...
        return tslib_es6.__generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              return [4 /*yield*/, api.requestToken(args)];
            case 1:
              data = _c.sent().data;
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              if (!cachedCodeVerifier) {
                throw new errors.CodeVerifierMissingError();
              }
              _a.label = 2;
            case 2:
              _a.trys.push([2, 6,, 8]);
      ...
      return tslib_es6.__awaiter(_this, void 0, void 0, function () {
        return tslib_es6.__generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              return [4 /*yield*/, this.setToken(tslib_es6.__assign(tslib_es6.__assign({}, data), {
        ...
        return tslib_es6.__generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 3:
              ...
              parsedToken = typeof token === 'string' ? utils.safeJsonParse(token) : token;
              cache = {
                token: parsedToken,
                code: code,
                codeVerifier: codeVerifier
    ...
    this.isTokenExpired = function () {
      var _a, _b;
      return utils.isLastUpdateTimestampExpired((_a = _this.token) === null || _a === void 0 ? void 0 : _a.last_update_at, (_b = _this.token) === null || _b === void 0 ? void 0 : _b.expires_in);
    };
        ...
        return tslib_es6.__generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              codeVerifier = utils.getRandomString(minVerifierLength);
              return [4 /*yield*/, utils.pkceChallengeFromVerifier(codeVerifier)];
            case 1:
              codeChallenge = _a.sent();
              return [4 /*yield*/, this.setCodeVerifier(codeVerifier)];
            case 2:
              _a.sent();
              loginUrl = api.getLogInUrl(tslib_es6.__assign(tslib_es6.__assign({}, this.config), {
...
exports.CODE_STORAGE_KEY = CODE_STORAGE_KEY;
exports.CODE_VERIFIER_STORAGE_KEY = CODE_VERIFIER_STORAGE_KEY;
