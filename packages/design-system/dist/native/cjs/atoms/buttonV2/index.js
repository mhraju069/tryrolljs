...
var BaseButton = function (_a) {
  ...
  return jsxRuntime.jsx(reactNative.View, tslib_es6.__assign({
    ...
    children: jsxRuntime.jsxs(nativeBase.Pressable, tslib_es6.__assign({
      ...
      children: [reactNative.Platform.OS === 'web' && jsxRuntime.jsx(reactNative.View, {
        ...
        children: [iconVariant && variant !== 'text' && jsxRuntime.jsx(reactNative.View, tslib_es6.__assign({
        ...
        })), !iconVariant && icon && variant !== 'text' && jsxRuntime.jsx(reactNative.View, tslib_es6.__assign({
          style: [styles.iconContainer]
        }, {
          children: icon
