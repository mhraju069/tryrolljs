...
var DesktopSidebar = function (_a) {
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [jsxRuntime.jsxs("div", tslib_es6.__assign({
      ...
      children: [logo.desktop && jsxRuntime.jsx(reactNative.View, tslib_es6.__assign({
        style: [margin.margin.mb40, container.container.fullWidth, container.container.alignCenter]
      }, {
        children: logo.desktop
      })), header && jsxRuntime.jsx(reactNative.View, tslib_es6.__assign({
      ...
      }), footerOnDesktop && jsxRuntime.jsx(reactNative.View, tslib_es6.__assign({
