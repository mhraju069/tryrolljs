...
var SidebarOption = function (_a) {
  ...
  return jsxRuntime.jsxs(reactNative.Pressable, tslib_es6.__assign({
    ...
    children: [jsxRuntime.jsxs(reactNative.View, tslib_es6.__assign({
      ...
      children: [hasSelectedOption && jsxRuntime.jsx(reactNative.View, {
        ...
        children: [iconVariant && jsxRuntime.jsx(reactNative.View, tslib_es6.__assign({
    ...
    })), !!(nestedOptions === null || nestedOptions === void 0 ? void 0 : nestedOptions.length) && showNestedOptions && jsxRuntime.jsx(reactNative.View, tslib_es6.__assign({
