...
var isWeb = reactNativeWeb.Platform.OS === 'web';
...
var Toast = function (_a) {
  ...
  var actionNode = React.useMemo(function () {
    ...
    if (isWeb) {
      return jsxRuntime.jsx(reactNativeWeb.TouchableOpacity, tslib_es6.__assign({
    ...
    return jsxRuntime.jsxs(jsxRuntime.Fragment, {
      ...
      }), jsxRuntime.jsx(reactNativeWeb.TouchableOpacity, tslib_es6.__assign({
        onPress: action.onPress
      }, {
        children: jsxRuntime.jsx(index.Caption, tslib_es6.__assign({
