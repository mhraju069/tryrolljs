...
var InputV2 = React.forwardRef(function (_a, ref) {
  ...
  return jsxRuntime.jsxs(reactNativeWeb.View, {
    children: [label && jsxRuntime.jsx(index.TypographyV2, tslib_es6.__assign({
      ...
      children: [prefix && jsxRuntime.jsx(reactNativeWeb.View, tslib_es6.__assign({
        style: [styles.prefix]
      }, {
        children: prefix
      })), jsxRuntime.jsx(reactNativeWeb.TextInput, tslib_es6.__assign({
        ref: ref,
      ...
      }, props)), suffix && jsxRuntime.jsx(reactNativeWeb.View, tslib_es6.__assign({
        style: [styles.suffix]
      }, {
        children: suffix
      })), counter && maxLength && jsxRuntime.jsx(reactNativeWeb.View, tslib_es6.__assign({
        style: [styles.count]
      }, {
