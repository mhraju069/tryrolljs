...
var MobileSidebar = function (_a) {
  ...
  var width = reactNativeWeb.Dimensions.get('window').width;
  ...
  var isNative = reactNativeWeb.Platform.OS !== 'web';
  var overlayStyles = {
  ...
  return jsxRuntime.jsxs(nativeBase.View, tslib_es6.__assign({
    ...
    children: [logo.mobileHeader, jsxRuntime.jsxs(nativeBase.View, tslib_es6.__assign({
      ...
      }), jsxRuntime.jsx(reactNativeWeb.Pressable, tslib_es6.__assign({
...
var FooterOption = function (_a) {
  ...
  return jsxRuntime.jsx(nativeBase.View, {
    children: jsxRuntime.jsx(reactNativeWeb.Pressable, tslib_es6.__assign({
      onPress: handlePress
    }, {
