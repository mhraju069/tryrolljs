...
var index_web = require('../../atoms/popover/index.js');
...
var Select = function (_a) {
  ...
  var optionOnPress = React.useMemo(function () {
    return reactNativeWeb.Platform.select({
      native: function () {
        var _a;
  ...
  var renderReference = React.useCallback(function (_a) {
    ...
    var inputProps = reactNativeWeb.Platform.select({
      web: referenceProps,
      native: {
        onFocus: function () {
  ...
  return jsxRuntime.jsx(index_web.Popover, tslib_es6.__assign({
    open: isOpen,
